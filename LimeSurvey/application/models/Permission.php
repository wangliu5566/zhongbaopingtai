...
class Permission extends LSActiveRecord
{
    ...
    */
    ...
    public function saveBasicPermission($uId){

        $sql = "INSERT INTO `answer`.`lime_permissions`
( `entity`, `entity_id`, `uid`, `permission`, `create_p`, `read_p`, `update_p`, `delete_p`, `import_p`, `export_p`)
VALUES
( 'global', '0', '".$uId."', 'participantpanel', '1', '1', '1', '1', '1', '1'),
 ( 'template', '0', '".$uId."', 'default', '0', '1', '0', '0', '0', '0'),
 ( 'global', '0', '".$uId."', 'labelsets', '1', '1', '1', '1', '1', '1'),
 ( 'global', '0', '".$uId."', 'templates', '1', '1', '1', '1', '1', '1'),
( 'global', '0', '".$uId."', 'users', '1', '1', '1', '1', '0', '0'),
( 'global', '0', '".$uId."', 'usergroups', '1', '1', '1', '1', '0', '0'),
( 'global', '0', '".$uId."', 'surveys', '1', '1', '1', '1', '0', '1'),
( 'global', '0', '".$uId."', 'settings', '0', '1', '1', '0', '1', '0'),
( 'global', '0', '".$uId."', 'superadmin', '0', '1', '0', '0', '0', '0'),
('global', '0', '".$uId."', 'auth_db', '0', '1', '0', '0', '0', '0'),
( 'template', '0', '".$uId."', 'news_paper', '0', '1', '0', '0', '0', '0'),
( 'template', '0', '".$uId."', 'ubuntu_orange', '0', '1', '0', '0', '0', '0')";
