...
<div class='col-sm-12 col-md-6'>
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="hidden" name="language" value="<?php echo Yii::app()->getConfig('defaultlang') ?>">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input type="hidden" name="createsample" value="0">
            </div>
        ...
        <div class="form-group pull-right">
            <button type="submit" name="save" class="btn btn-success" value='insertsurvey'><?php eT("Save"); ?></button>
        </div>
