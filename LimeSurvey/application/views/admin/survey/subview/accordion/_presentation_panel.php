...
<div id='presentation' class="tab-pane fade in">
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="showwelcome" value="0">
        </div>
    <!--</div>-->
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="allowprev" value="0">
        </div>
    <!--</div>-->
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="nokeyboard" value="0">
        </div>
    <!--</div>-->
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="showprogress" value="1">
        </div>
    <!--</div>-->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="printanswers" value="0">
        </div>
    </div>
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-7">
            ...
            */?>
            <input type="hidden" name="publicgraphs" value="0">
        </div>
    <!--</div>-->
        ...
        <?php default: ?>
            ...
            <!--<div class="form-group">-->
                ...
                <div class="col-sm-7">
                    ...
                    <input type="hidden" name="showgroupinfo" value="B">
                </div>
            <!--</div>-->
        <?php break;?>
        ...
        <?php default: ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <input type="hidden" name="showqnumcode" value="X">
                </div>
            </div>
        <?php break;?>
    <?php endswitch; ?>
