...
<?php else: ?>
    ...
    <input type="hidden" name="owner_id" value="<?php echo $esrow['owner_id']; ?>">
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="numberformat" value="0">
        </div>
    <!--</div>-->
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label" for='adminemail'><?php  eT("Admin email:") ; ?></label>
        <div class="col-sm-9">
            <input type='email' size='30' class="form-control" id='adminemail' name='adminemail' readonly value='<?php echo 'kefu@kingchannels.com';//$owner['email'] ; ?>' />
        </div>
    </div>
    ...
    <!--<div class="form-group">-->
        ...
        <!--<div class="col-sm-9">-->
            ...
            <input type="hidden" name="bounce_email" value='<?php echo $owner['bounce_email']; ?>'>
        <!--</div>-->
    <!--</div>-->
...
<!--<div class="form-group">-->
    ...
    <div class="col-sm-5">
        ...
        <input type="hidden" name="template" value="news_paper">
    </div>
