...
<div id='publication' class="tab-pane fade in">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            */?>
            <input type="hidden" name="listpublic" value="1">
        </div>
    </div>
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-6">
            ...
            */?>
            <input type="hidden" name="usecaptcha_surveyaccess" value="0">
        </div>
    <!--</div>-->
    ...
    <!--<div class="form-group">-->
        ...
        <div class="col-sm-6">
            <?php /*$this->widget('yiiwheels.widgets.switch.WhSwitch', array(
                ...
                'offLabel'=>gT('Off')));
            */?>
            <input type="hidden" name="usecaptcha_registration" value="0">
        </div>
    <!--</div>-->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php /*$this->widget('yiiwheels.widgets.switch.WhSwitch', array(
                ...
                'offLabel'=>gT('Off')));
            */?>
            <input type="hidden" name="usecaptcha_saveandload" value="0">
        </div>
    </div>
