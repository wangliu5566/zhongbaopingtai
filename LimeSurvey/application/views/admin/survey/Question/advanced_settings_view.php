...
<script>
    var element = $('#advancedquestionsettings');
    var count = element.children('fieldset').length;

    if(count == 1){
        $('#advancedquestionsettings fieldset div:first-child').css('display', 'none');

        var el = $('#advancedquestionsettings fieldset div:nth-child(2)');
        el.css('display', 'none');
    }else{
        var ele = $('#advancedquestionsettings fieldset:first-child');
