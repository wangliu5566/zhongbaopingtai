...
<div id="edittxtele-<?php echo $i;?>" class="tab-pane fade in <?php if($i==0){echo "active";}?> center-box">
    ...
    <input type="hidden" name="dateformat_<?php echo $esrow['surveyls_language']; ?>" value="6">
...
/*                $aRadixPoint=array();
    ...
    <input type="hidden" name="numberformat_<?php echo $esrow['surveyls_language']; ?>" value="0">
        ...
        <div class="col-sm-8">
            <div id="generaloptions" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                    <?php $this->renderPartial('/admin/survey/subview/accordion/_generaloptions_panel', $esrow); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div id="presentationoptions" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="presentationoptions">
                <div class="panel-body">
                    <?php $this->renderPartial('/admin/survey/subview/accordion/_presentation_panel', $esrow); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div id="publicationoptions" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="publicationoptions">
                <div class="panel-body">
                    <?php $this->renderPartial('/admin/survey/subview/accordion/_publication_panel', $esrow); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-4 pull-right">
            <a class="btn btn-success" href="#" role="button" id="save-button">保存</a>
        </div>
    </div>
