...
export default {
  data() {
    return {
      playerOptions: {
        ...
        height: 500,
        autoplay: true
        // poster: "../../../static/img/default_photo.png",
      }
    }
  },
  props: ['datas'],
  ...
  methods: {
    setVideoUrl() {
      this.playerOptions.sources[0].src = this.datas;
      this.playerOptions.sources[1].src = this.datas;
      this.playerOptions.sources[2].src = this.datas;
    },
